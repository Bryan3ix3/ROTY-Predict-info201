...
summary <- list("Points per game" = points_per_game, "Field goal percentage" = fg_percent, "Three point percentage" = three_point_percent, "Free throw percentage" = free_throw_percent, "Assists per game" = assist_per_game)
